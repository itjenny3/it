...
public class SocialUser {
	...
	public static final String DEFAULT_IT_USER_PROFILE_SUFFIX = "http://www.gravatar.com/avatar/";
	...
	public void update(String email, String userId) {
		...
		if (isItUser()) {
			this.imageUrl = DEFAULT_IT_USER_PROFILE_SUFFIX + MD5Util.md5Hex(email);
		}
	}
