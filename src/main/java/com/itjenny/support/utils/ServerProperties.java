...
public class ServerProperties extends Properties {
    ...
    private static final Pattern SYSTEM_PROPERTY_NAME_PATTERN = Pattern
            .compile("\\$\\{([\\w\\.]+)\\}");
    ...
    private void convertSystemPropertyToValue(Matcher matcher, StringBuffer sb) {
        ...
        log.debug("sysProperty Name: {}, Value: {}", sysPropertyName,
                sysPropertyValue);
        ...
        matcher.appendReplacement(
                sb,
                sysPropertyValue.replaceAll("\\\\", "\\\\\\\\").replaceAll(
                        "\\$", "\\\\\\$"));
    }
