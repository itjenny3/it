...
public class ItTokenBasedRememberMeServices extends AbstractRememberMeServices {
    private final Logger logger = LoggerFactory
            .getLogger(ItTokenBasedRememberMeServices.class);
    ...
    public ItTokenBasedRememberMeServices(String key,
    ...
    private ItUser getItUserDetails(ProviderType providerType,
            String firstCookieToken) {
        if (providerType == ProviderType.it) {
            ItUserDetailsService itUserDetailsService = (ItUserDetailsService) getUserDetailsService();
            return (ItUser) itUserDetailsService
                    .loadUserByEmail(firstCookieToken);
        } else {
            return (ItUser) getUserDetailsService().loadUserByUsername(
                    firstCookieToken);
        }
    }
    ...
    public void onLoginSuccess(HttpServletRequest request,
        ...
        setCookie(new String[] { username, Long.toString(expiryTime),
                signatureValue, providerType.name() }, tokenLifetime, request,
                response);
