...
public class ItUserDetailsService implements UserDetailsService {
    private final Logger logger = LoggerFactory
            .getLogger(ItUserDetailsService.class);
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        return new ItUser(username, socialUser.getAccessToken(),
                socialUser.getProviderIdBySnsType(),
    ...
    public UserDetails loadUserByEmail(String email) {
        ...
        return new ItUser(email, socialUser.getPassword(),
                socialUser.getProviderIdBySnsType(),
