...
public class JpaConnectionRepository implements ConnectionRepository {
    ...
    public JpaConnectionRepository(String userId,
	...
	List<Connection<?>> resultList = connectionMapper
		.mapEntities(socialUserRepository.findsByUserId(userId));
	...
	return connectionMapper.mapEntities(socialUserRepository
		.findsByUserIdAndProviderId(userId, providerId));
    }
	...
	List<Connection<?>> resultList = connectionMapper
		.mapEntities(socialUserRepository
			.findsByUserIdAndProviderUserIds(userId,
				providerUserIds));
	...
	try {
	    return connectionMapper.mapEntity(socialUserRepository
	...
	List<Connection<?>> connections = connectionMapper
		.mapEntities(socialUserRepository.findsPrimary(userId,
			providerId));
	...
	List<Integer> result = socialUserRepository.findsRank(userId,
		providerId);
	...
	SocialUser su = socialUserRepository
		.findByUserIdAndProviderIdAndProviderUserId(userId,
	...
	SocialUser socialUser = socialUserRepository.findByUserIdAndProviderId(
		userId, providerId);
