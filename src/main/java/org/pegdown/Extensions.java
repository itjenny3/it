...
public interface Extensions {
     ...
     * 
     * @see <a href="http://michelf.com/projects/php-markdown/extra/#abbr">PHP
     *      Markdown Extra</a>
     */
     ...
     * 
     * @see <a
     *      href="http://github.github.com/github-flavored-markdown">Github-flavored-Markdown</a>
     */
    static final int HARDWRAPS = 0x08;

    /**
     * Enables plain autolinks the way github flavoured markdown implements
     * them. With this extension enabled pegdown will intelligently recognize
     * URLs and email addresses without any further delimiters and mark them as
     * the respective link type.
     * 
     * @see <a
     *      href="http://github.github.com/github-flavored-markdown">Github-flavored-Markdown</a>
     */
     ...
     * 
     * @see <a
     *      href="http://fletcherpenney.net/multimarkdown/users_guide/">MultiMarkdown</a>
     */
    static final int TABLES = 0x20;

    /**
     * PHP Markdown Extra style definition lists. Additionally supports the
     * small extension proposed in the article referenced below.
     * 
     * @see <a
     *      href="http://michelf.com/projects/php-markdown/extra/#def-list">PHP
     *      Markdown Extra</a>
     * @see <a
     ...
     * 
     * @see <a
     *      href="http://michelf.com/projects/php-markdown/extra/#fenced-code-blocks">PHP
     *      Markdown Extra</a>
     */
    ...
    /**
     * Suppresses HTML blocks as well as inline HTML tags. Both will be accepted
     * in the input but not be contained in the output.
     */
