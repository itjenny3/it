 ...
 * implemented with parboiled. Note: A PegDownProcessor is not thread-safe
 * (since it internally reused the parboiled parser instance). If you need to
 * process markdown source in parallel create one PegDownProcessor per thread!
 * 
...
public class PegDownProcessor {
    ...
    /**
     * Creates a new processor instance without any enabled extensions and the
     * default parsing timeout.
     */
     ...
     * {@link org.pegdown.Extensions} and the default parsing timeout.
     * 
     * @param options
    ...
    /**
     * Creates a new processor instance with the given
     * {@link org.pegdown.Extensions} and parsing timeout.
     * 
     * @param options
     *            the flags of the extensions to enable as a bitmask
    ...
    /**
     * Creates a new processor instance with the given
     * {@link org.pegdown.Extensions} and plugins.
     * 
     * @param options
     *            the flags of the extensions to enable as a bitmask
     * @param plugins
    ...
    /**
     * Creates a new processor instance with the given
     * {@link org.pegdown.Extensions}, parsing timeout and plugins.
     * 
     * @param options
     *            the flags of the extensions to enable as a bitmask
     * @param maxParsingTimeInMillis
    ...
    public PegDownProcessor(int options, long maxParsingTimeInMillis,
        ...
        this(Parboiled.createParser(Parser.class, options,
                maxParsingTimeInMillis, Parser.DefaultParseRunnerProvider,
                plugins));
    }
    ...
    /**
     * Converts the given markdown source to HTML. If the input cannot be parsed
    ...
    public String markdownToHtml(char[] markdownSource,
        ...
        try {
            ...
            return new ToHtmlSerializer(linkRenderer, verbatimSerializerMap)
                    .toHtml(astRoot);
    ...
    /**
     * Parses the given markdown source and returns the root node of the
