...
function enableCloseEditContentOfMyDoc(myDocId) {
    $(document).bind(
		...
		if (id != "rawContent" + myDocId
			&& id != "updateRawContent" + myDocId
			&& id != "deleteRawContent" + myDocId) {
...
function enableCloseEditContent(documentId) {
    $(document).bind(
	    ...
	    function(event) {
		var id = event.target.id;
		if (id != "rawContent" + documentId
			&& id != "updateRawContent" + documentId
...
function dislike(documentId) {
    $
		...
		success : function(isSuccess) {
		    if (isSuccess === "true") {
			var dislike = parseInt($("#dislike" + documentId)
				.text());
