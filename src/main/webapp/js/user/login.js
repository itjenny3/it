$(document)
	.ready(
		function() {
		    $.validator.addMethod("duplicateUserId", function(value,
			    element, param) {
			var validator = this;
			...
			$.ajax({
				...
				var errors = {};
				errors[element.name] = SL10N.User
		    ...
		    $.validator.addMethod("duplicateEmail", function(value,
			    element, param) {
			var validator = this;
			var email = $(param).val();
